...
const initialHeightOfPopup = 780.0;
...
class _MyAppState extends State<MyApp> with SingleTickerProviderStateMixin {
  ...
  void updateUI({@required double value}) {
    setState(() {
      ...
      bottomPopup = -(1 - value) * (initialHeightOfPopup - hidingHeightOfPopup);
    ...
    return MaterialApp(
      ...
      home: MyHomePage(
        ...
        onDragUpdate: (details) {
          ...
          final value =
              1 - (verticalDrag / initialHeightOfPopup).abs().clamp(0.01, 1.0);

          updateUI(value: value);
        },
        onDragEnd: (_) {
          final value = verticalDrag / initialHeightOfPopup;
        ...
        onStart: () {
          verticalDrag = isHide ? initialHeightOfPopup : 0.0;
        },
      ),
    );
  }
      ...
      child: Column(
        children: [
          ...
          Opacity(
            opacity: otherOpacity,
            child: Text(
              'It is a long estabilished fact that a reader',
  ...
  buildStackDisk() {
    return Transform.translate(
        ...
        child: InkWell(
          ...
          child: Container(
              child: Image(
            image: AssetImage('assets/images/song_avatar.png'),
            width: diskHeight,
            height: diskHeight,
            fit: BoxFit.cover,
          )),
